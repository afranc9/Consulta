<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hablemos2.aspx.cs" Inherits="App_hablemos" %>
...
<body>
            ...
            <div class="container">
                ...
                <div id="MenuCollapse" class="nav-collapse collapse MenuLeftCollapse">
                    <ul class="nav" id="top-navigation">
                        ...
                        <li class="active"><a class="itemMenu" href="hablemos2.aspx">MAMÁ, PAPÁ HABLEMOS DE SEXUALIDAD</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div id="tips" style="background-color:white; background-image: url(../img/fondoamarillo.jpeg);background-color: white;" class="section secondary-section">
